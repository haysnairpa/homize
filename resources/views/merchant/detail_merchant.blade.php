...
<body class="font-sans antialiased bg-homize-gray">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div class="flex-grow">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <button id="followBtn" data-merchant-id="{{ $merchant->id }}"
                            class="px-6 py-2 {{ $isFollowing ? 'bg-homize-blue text-homize-white' : 'bg-white text-homize-blue border-2 border-homize-blue' }} rounded-lg hover:bg-homize-blue-second  hover:text-white transition-colors flex items-center gap-2">
                    ...
                    <div class="flex items-center gap-8">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <span class="text-gray-600" id="followerCount">{{ $merchant->follower_count }}
                                Pengikut</span>
                        </div>
                        <div class="flex items-center gap-2">
                            <svg class="w-5 h-5 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="flex flex-wrap items-center justify-between gap-4 mb-8">
            <div class="flex items-center gap-4">
                <select id="sortSelect"
                    class="px-8 py-2 bg-white rounded-lg shadow-sm border border-gray-200 text-gray-700 focus:outline-none focus:ring-2 focus:ring-homize-blue">
        ...
        <!-- Services Grid -->
        <div id="servicesGrid" class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
        ...
        followBtn.addEventListener('click', async function() {
            ...
            try {
                ...
                if (data.status === 'followed') {
                    ...
                    this.innerHTML =
                        '<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>Mengikuti';
                    ...
                    this.innerHTML =
                        '<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/></svg>Ikuti';
                    // Update follower count
                    const currentCount = parseInt(followerCount.textContent);
                    followerCount.textContent = `${currentCount - 1} Pengikut`;
                }
