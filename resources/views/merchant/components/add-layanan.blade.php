<div class="container mx-auto py-8 px-4 max-w-4xl">
    <form id="layananForm" method="POST" action="{{ route('merchant.layanan.store') }}" enctype="multipart/form-data">
        ...
        <div class="space-y-8">
            ...
            <!-- Notifikasi error -->
            <div id="errorMessages" class="hidden bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative mb-4">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden transition-all duration-200 hover:shadow-md">
                <div class="p-5 border-b border-gray-100 bg-gradient-to-r from-primary/5 to-transparent">
                    <div class="flex items-center space-x-2">
                        <div class="bg-primary/10 p-2 rounded-full">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-primary" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 16v-4"/><path d="M12 8h.01"/></svg>
                        </div>
                ...
                <div class="p-6 space-y-5">
                    <div class="space-y-2">
                        ...
                        <input type="text" id="nama_layanan" name="nama_layanan" placeholder="Masukkan nama layanan" required
                    ...
                    <div class="space-y-2">
                        <label for="deskripsi_layanan" class="block text-sm font-medium text-gray-700">Deskripsi <span class="text-red-500">*</span></label>
                        <textarea id="deskripsi_layanan" name="deskripsi_layanan" rows="4" placeholder="Jelaskan detail layanan yang Anda tawarkan" required
                        ...
                        <p class="text-xs text-gray-500 mt-1">Deskripsikan layanan Anda secara detail agar pelanggan memahami apa yang Anda tawarkan.</p>
                    </div>
                    
                    <div class="space-y-2">
                        <label for="pengalaman" class="block text-sm font-medium text-gray-700">Pengalaman (tahun)</label>
                        <div class="relative">
                            <input type="number" id="pengalaman" name="pengalaman" min="0" placeholder="Berapa tahun pengalaman Anda"
                                class="w-full px-4 py-2.5 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden transition-all duration-200 hover:shadow-md">
                <div class="p-5 border-b border-gray-100 bg-gradient-to-r from-primary/5 to-transparent">
                    <div class="flex items-center space-x-2">
                        <div class="bg-primary/10 p-2 rounded-full">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-primary" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 1v22M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                ...
                                <input type="number" id="harga" name="harga" min="0" placeholder="Masukkan harga layanan" required
                        ...
                        <div class="space-y-2">
                            ...
                            <select name="satuan" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-homize-blue focus:ring-homize-blue">
                        ...
                        <div class="space-y-2">
                            <label for="durasi" class="block text-sm font-medium text-gray-700">Durasi <span class="text-red-500">*</span></label>
                            <input type="number" id="durasi" name="durasi" min="0" placeholder="Masukkan durasi layanan" required
                                class="w-full px-4 py-2.5 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all">
                        </div>
                        
                        <div class="space-y-2">
                            <label for="tipe_durasi" class="block text-sm font-medium text-gray-700">Tipe Durasi <span class="text-red-500">*</span></label>
                            <div class="relative">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden transition-all duration-200 hover:shadow-md">
                <div class="p-5 border-b border-gray-100 bg-gradient-to-r from-primary/5 to-transparent">
                    <div class="flex items-center space-x-2">
                        <div class="bg-primary/10 p-2 rounded-full">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-primary" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>
                        </div>
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div class="space-y-2">
                            <label for="jam_buka" class="block text-sm font-medium text-gray-700">Jam Buka <span class="text-red-500">*</span></label>
                            <input type="time" id="jam_buka" name="jam_operasional[jam_buka]" required
                                class="w-full px-4 py-2.5 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all">
                        </div>
                        
                        <div class="space-y-2">
                            <label for="jam_tutup" class="block text-sm font-medium text-gray-700">Jam Tutup <span class="text-red-500">*</span></label>
                            <input type="time" id="jam_tutup" name="jam_operasional[jam_tutup]" required
                                class="w-full px-4 py-2.5 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all">
                        </div>
                    </div>
                    <div class="space-y-2">
                        <label for="hari" class="block text-sm font-medium text-gray-700">Hari Operasional <span class="text-red-500">*</span></label>
                        <select id="hari" name="jam_operasional[hari]" required class="w-full px-4 py-2.5 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden transition-all duration-200 hover:shadow-md">
                <div class="p-5 border-b border-gray-100 bg-gradient-to-r from-primary/5 to-transparent">
                    <div class="flex items-center space-x-2">
                        <div class="bg-primary/10 p-2 rounded-full">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-primary" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg>
                        </div>
                ...
                <div class="p-6 space-y-6">
                    <div class="space-y-3">
                        <label for="aset_layanan" class="block text-sm font-medium text-gray-700">Foto Layanan <span class="text-red-500">*</span></label>
                        <div id="dropzone" class="border-2 border-dashed border-gray-200 rounded-lg p-8 text-center hover:bg-gray-50 transition-colors cursor-pointer group">
                            <input id="aset_layanan" name="aset_layanan[]" type="file" multiple accept="image/*" class="hidden" required>
                            <label for="aset_layanan" class="cursor-pointer">
                                <div class="flex flex-col items-center gap-3">
                                    <div class="p-3 bg-primary/10 rounded-full group-hover:bg-primary/20 transition-colors">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 text-primary" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="17 8 12 3 7 8"/><line x1="12" y1="3" x2="12" y2="15"/></svg>
                                    </div>
                                    <div>
                                        <span class="text-sm font-medium text-gray-700">Klik untuk mengunggah foto layanan</span>
                        ...
                        <div id="preview-container" class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3 mt-3 hidden">
                    ...
                    <div class="space-y-4">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-xs text-gray-500 mt-1">Tambahkan sertifikasi untuk meningkatkan kredibilitas Anda</p>
                            </div>
                        ...
                        <div id="sertifikasi-container" class="space-y-4">
                            <div class="p-5 border rounded-lg bg-gray-50/50 hover:bg-white transition-colors">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                                    <div class="space-y-2">
                                        <label for="sertifikasi_nama_0" class="block text-sm font-medium text-gray-700">Nama Sertifikasi</label>
                                        <input type="text" id="sertifikasi_nama_0" name="sertifikasi[0][nama]" placeholder="Masukkan nama sertifikasi"
                                            class="w-full px-4 py-2.5 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all">
                                    </div>
                                    <div class="space-y-2">
                                        <label for="sertifikasi_file_0" class="block text-sm font-medium text-gray-700">File Sertifikasi</label>
                                        <input type="file" id="sertifikasi_file_0" name="sertifikasi[0][file]" accept="image/*"
                                            class="w-full px-4 py-2.5 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all">
                                    </div>
                                </div>
                            </div>
            ...
            <div class="flex flex-col sm:flex-row justify-between gap-4">
                <a href="" 
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="19" y1="12" x2="5" y2="12"/><polyline points="12 19 5 12 12 5"/></svg>
                    Kembali
                </a>
                <button type="submit" 
                class="inline-flex items-center justify-center px-4 py-2.5 bg-white text-gray-700 border border-gray-300 rounded-lg hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 transition-colors">
