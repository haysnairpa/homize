                ...
                <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
                    ...
                    <div class="lg:col-span-7">
                            ...
                            <div class="form-card-body">
                                <div class="space-y-4">
                                    <div>
                                        ...
                                        <textarea id="alamat_pembeli" name="alamat_pembeli" rows="3" required class="form-input"
                        ...
                        <div class="form-card mb-6 bg-white">
                            ...
                            <div class="form-card-body">
                                <div>
                                    <textarea id="catatan" name="catatan" rows="3" class="form-input"
                ...
                if (navigator.geolocation) {
                    navigator.geolocation.getCurrentPosition(
                        function(position) {
                            ...
                            getLocationBtn.innerHTML =
                                '<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clip-rule="evenodd" /></svg> Gunakan Lokasi Saat Ini';
                        ...
                        function(error) {
                            ...
                            switch (error.code) {
                                case error.PERMISSION_DENIED:
                                    errorMessage =
                                        'Akses lokasi ditolak. Silakan aktifkan izin lokasi di browser Anda.';
                                    break;
