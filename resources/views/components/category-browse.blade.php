    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mt-12 grid self-center grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            @foreach ($navigation as $nav)
                <div class="group relative overflow-hidden rounded-2xl bg-white shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                    ...
                    <!-- Hover Content -->
                    <div class="absolute inset-0 bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-30 flex items-center justify-center">
                        <div class="text-center p-6">
                            ...
                            <a href="#" class="inline-block mt-4 px-4 py-2 bg-white text-homize-blue text-sm font-medium rounded-full hover:bg-homize-orange hover:text-white transition-colors duration-300">
                                View All
                            </a>
                        </div>
                    </div>
