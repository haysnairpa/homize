    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mt-12 grid gap-8 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <a href="{{ route('services.show', $service->id) }}" class="block bg-white overflow-hidden shadow-lg rounded-lg transition-all duration-300 hover:shadow-xl">
                <div class="relative">
                    <img src="{{ $service->image_url ?? asset('images/service-default.jpg') }}" alt="{{ $service->name }}" class="w-full h-48 object-cover">
                ...
                <div class="p-6">
                    ...
                    <p class="mt-2 text-gray-600">{{ Str::limit($service->description ?? 'Professional service with quality guarantee', 100) }}</p>
