...
<div class="bg-homize-white py-16">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center">
            <h2 class="text-3xl font-bold text-homize-blue mb-2">Popular Services</h2>
            <p class="text-gray-600 mb-8">Most booked services by our customers</p>
        </div>

        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            @foreach($popularServices as $shopService)
