...
<div style="text-align: center; margin-bottom: 30px;">
    ...
    <h1 style="color: #30a0e0; margin: 0; font-size: 24px; font-weight: 700;">Pesanan Anda Telah Dikonfirmasi!</h1>
</div>
...
<div style="background-color: #f0f9ff; border-radius: 8px; padding: 20px; margin-bottom: 25px; border-left: 4px solid #30a0e0;">
    ...
    <p style="margin-top: 0; font-size: 16px;">Kabar baik! Pesanan Anda telah dikonfirmasi oleh penyedia layanan. Berikut detail pesanan Anda:</p>
</div>
...
<div style="background-color: #e6f7f0; border-radius: 8px; padding: 15px; margin-bottom: 25px; text-align: center; border-left: 4px solid #34d399;">
    <p style="margin: 0; font-size: 14px; color: #065f46;">Penyedia layanan akan segera menghubungi Anda untuk detail lebih lanjut jika diperlukan.</p>
</div>
