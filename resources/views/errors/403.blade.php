            ...
            <div class="flex flex-col items-center pt-8 sm:justify-center sm:pt-0">
                ...
                <div class="w-full px-8 py-12 overflow-hidden bg-white/180 dark:bg-gray-800/70 shadow-2xl rounded-xl backdrop-blur-lg border border-black/20 dark:border-gray-700/30">
                    <div class="text-center">
                        ...
                        <div class="flex justify-center mb-10 transform hover:scale-105 transition-all duration-700 ease-out">
                            <div class="relative">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 240 160" class="w-64 h-48">
                                    ...
                                    <!-- Lock icon -->
                                    <g transform="translate(120, 80) scale(1.8)" filter="url(#shadow)">
                                        <rect x="-15" y="-5" width="30" height="25" rx="4" fill="#30A0E0" />
                                        <rect x="-10" y="-15" width="20" height="15" rx="10" stroke="#30A0E0" stroke-width="4" fill="none" />
                                        <circle cx="0" cy="5" r="3" fill="white" />
                                        <line x1="0" y1="5" x2="0" y2="10" stroke="white" stroke-width="2" />
                                    </g>
                                    
                                    <!-- Text "403" -->
                                    <text x="50%" y="85%" dominant-baseline="middle" text-anchor="middle" class="text-4xl font-black" fill="#FFC973" stroke="#E0A040" stroke-width="1">403</text>
                                </svg>
                        ...
                        <!-- Enhanced typography -->
                        <h1 class="text-5xl sm:text-6xl font-black tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-[#30A0E0] to-[#FFC973] mb-4">Akses Ditolak</h1>
                        <p class="text-xl text-black mb-10 max-w-xl mx-auto leading-relaxed">
                            Maaf, Anda tidak memiliki izin untuk mengakses halaman ini. Silakan kembali ke halaman sebelumnya atau beranda.
                        </p>
                ...
                <div class="mt-10 text-center text-sm text-gray-500 dark:text-gray-400">
                    <p>Jika Anda yakin seharusnya memiliki akses, silakan 
