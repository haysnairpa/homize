            ...
            <div class="flex flex-col items-center pt-8 sm:justify-center sm:pt-0">
                ...
                <div class="w-full px-8 py-12 overflow-hidden bg-white/180 dark:bg-gray-800/70 shadow-2xl rounded-xl backdrop-blur-lg border border-black/20 dark:border-gray-700/30">
                    <div class="text-center">
                        ...
                        <div class="flex justify-center mb-10 transform hover:scale-105 transition-all duration-700 ease-out">
                            <div class="relative">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 240 160" class="w-64 h-48">
                                    ...
                                    <!-- Server icon with animated elements -->
                                    <g transform="translate(120, 80) scale(0.8)" filter="url(#shadow)">
                                        <!-- Server tower -->
                                        <rect x="-30" y="-40" width="60" height="80" rx="5" fill="#30A0E0" />
                                        
                                        <!-- Server details -->
                                        <rect x="-25" y="-35" width="50" height="10" rx="2" fill="#FFC973" />
                                        <rect x="-25" y="-20" width="50" height="10" rx="2" fill="white" opacity="0.7" />
                                        <rect x="-25" y="-5" width="50" height="10" rx="2" fill="white" opacity="0.7" />
                                        <rect x="-25" y="10" width="50" height="10" rx="2" fill="white" opacity="0.7" />
                                        <rect x="-25" y="25" width="50" height="10" rx="2" fill="#FFC973" />
                                        
                                        <!-- Lightning bolt -->
                                        <path d="M 40,-10 L 20,15 L 30,15 L 10,40 L 15,20 L 5,20 L 25,-10 Z" fill="#FFC973" class="animate-pulse-slow" />
                                    </g>
                                    
                                    <!-- Text "500" -->
                                    <text x="50%" y="85%" dominant-baseline="middle" text-anchor="middle" class="text-4xl font-black" fill="#FFC973" stroke="#E0A040" stroke-width="1">500</text>
                                </svg>
                        ...
                        <!-- Enhanced typography -->
                        <h1 class="text-5xl sm:text-6xl font-black tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-[#30A0E0] to-[#FFC973] mb-4">Terjadi Kesalahan Server</h1>
                        <p class="text-xl text-black mb-10 max-w-xl mx-auto leading-relaxed">
                            Maaf, server kami sedang mengalami masalah. Tim teknis kami telah diberitahu dan sedang bekerja untuk memperbaikinya.
                        </p>
                        ...
                        <div class="flex flex-col space-y-4 sm:flex-row sm:space-y-0 sm:space-x-6 justify-center">
                            ...
                            <button onclick="window.location.reload()" class="group relative inline-flex items-center px-7 py-3.5 text-base font-semibold text-gray-800 bg-gradient-to-r from-[#FFC973] to-[#FFB953] border border-transparent rounded-xl shadow-lg transition-all duration-300 transform hover:-translate-y-1 overflow-hidden">
