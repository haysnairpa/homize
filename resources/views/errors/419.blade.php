            ...
            <div class="flex flex-col items-center pt-8 sm:justify-center sm:pt-0">
                ...
                <div class="w-full px-8 py-12 overflow-hidden bg-white/180 dark:bg-gray-800/70 shadow-2xl rounded-xl backdrop-blur-lg border border-black/20 dark:border-gray-700/30">
                    <div class="text-center">
                        ...
                        <div class="flex justify-center mb-10 transform hover:scale-105 transition-all duration-700 ease-out">
                            <div class="relative">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 240 160" class="w-64 h-48">
                                    ...
                                    <!-- Hourglass icon -->
                                    <g transform="translate(120, 80) scale(1.5)" filter="url(#shadow)">
                                        <!-- Hourglass outline -->
                                        <path d="M -15,-20 L 15,-20 L 15,-15 C 15,-5 0,0 0,0 C 0,0 15,5 15,15 L 15,20 L -15,20 L -15,15 C -15,5 0,0 0,0 C 0,0 -15,-5 -15,-15 Z" 
                                              fill="#30A0E0" stroke="#1E88C7" stroke-width="1" />
                                        
                                        <!-- Sand top (decreasing) -->
                                        <path d="M -12,-18 L 12,-18 L 12,-15 C 12,-8 0,-3 0,-3 L 0,-3 C 0,-3 -12,-8 -12,-15 Z" 
                                              fill="#FFC973" class="animate-pulse-slow" />
                                    ...
                                    <!-- Text "419" -->
                                    <text x="50%" y="85%" dominant-baseline="middle" text-anchor="middle" class="text-4xl font-black" fill="#FFC973" stroke="#E0A040" stroke-width="1">419</text>
                                </svg>
                        ...
                        <!-- Enhanced typography -->
                        <h1 class="text-5xl sm:text-6xl font-black tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-[#30A0E0] to-[#FFC973] mb-4">Sesi Telah Berakhir</h1>
                        <p class="text-xl text-black mb-10 max-w-xl mx-auto leading-relaxed">
                            Maaf, sesi Anda telah berakhir atau token CSRF telah kedaluwarsa. Silakan muat ulang halaman dan coba lagi.
                        </p>
