            ...
            <div class="flex flex-col items-center pt-8 sm:justify-center sm:pt-0">
                ...
                <div class="w-full px-8 py-12 overflow-hidden bg-white/180 dark:bg-gray-800/70 shadow-2xl rounded-xl backdrop-blur-lg border border-black/20 dark:border-gray-700/30">
                    <div class="text-center">
                            ...
                            <div class="relative">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 240 160" class="w-64 h-48">
                                    ...
                                    <g transform="translate(120, 80) scale(1.2)" filter="url(#shadow)">
                                        <!-- Lock body -->
                                        <rect x="-20" y="-10" width="40" height="30" rx="5" fill="#30A0E0" />
                                        
                                        <!-- Lock shackle -->
                                        <path d="M -10,-10 C -10,-20 10,-20 10,-10" stroke="#30A0E0" stroke-width="6" fill="none" />
                                        
                                        <!-- Keyhole -->
                                        <circle cx="0" cy="5" r="6" fill="#FFC973" />
                                        <rect x="-1" y="5" width="2" height="8" fill="#FFC973" />
                                        
                                        <!-- Key -->
                                        <g class="animate-float-slow" transform="translate(30, 5) rotate(45)">
                                            <rect x="-25" y="-3" width="25" height="6" rx="2" fill="#FFC973" />
                                            <rect x="-30" y="-6" width="5" height="12" rx="2" fill="#FFC973" />
                                            <rect x="-35" y="-3" width="5" height="6" rx="1" fill="#FFC973" />
                                        </g>
                                    </g>
                                    
                                    <!-- Text "401" -->
                                    <text x="50%" y="85%" dominant-baseline="middle" text-anchor="middle" class="text-4xl font-black" fill="#FFC973" stroke="#E0A040" stroke-width="1">401</text>
                                </svg>
                        ...
                        <!-- Enhanced typography -->
                        <h1 class="text-5xl sm:text-6xl font-black tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-[#30A0E0] to-[#FFC973] mb-4">Autentikasi Diperlukan</h1>
                        <p class="text-xl text-black mb-10 max-w-xl mx-auto leading-relaxed">
                            Maaf, Anda perlu login terlebih dahulu untuk mengakses halaman ini. Silakan login atau daftar untuk melanjutkan.
                        </p>
                        ...
                        <div class="flex flex-col space-y-4 sm:flex-row sm:space-y-0 sm:space-x-6 justify-center">
                            <a href="{{ url('/login') }}" class="group relative inline-flex items-center px-7 py-3.5 text-base font-semibold bg-gradient-to-r from-[#30A0E0] to-[#1E88C7] border border-transparent rounded-xl shadow-lg transition-all duration-300 transform hover:-translate-y-1 overflow-hidden">
                            ...
                            <a href="{{ url('/register') }}" class="group relative inline-flex items-center px-7 py-3.5 text-base font-semibold text-gray-800 bg-gradient-to-r from-[#FFC973] to-[#FFB953] border border-transparent rounded-xl shadow-lg transition-all duration-300 transform hover:-translate-y-1 overflow-hidden">
                ...
                <div class="mt-10 text-center text-sm text-gray-500 dark:text-gray-400">
                    <p>Jika Anda sudah login dan masih melihat pesan ini, silakan 
