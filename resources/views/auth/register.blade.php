            ...
            <div class="w-full max-w-md">
                ...
                <form method="POST" action="{{ route('register') }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <x-input id="nama" class="w-full px-4 py-3 border border-gray-300 rounded-md" type="text" name="nama" :value="old('nama')" required autofocus autocomplete="nama" placeholder="Nama" />
                        @error('nama')
