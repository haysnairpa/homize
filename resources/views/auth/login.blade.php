    ...
    <div class="flex flex-col md:flex-row min-h-screen">
        ...
        <div class="w-full md:w-1/2 p-6 md:p-12 flex items-center justify-center bg-white">
            <div class="w-full max-w-md">
                ...
                @endif
                <form method="POST" action="{{ route('login') }}" class="space-y-5 md:space-y-6" id="loginForm">
                    @csrf
                    ...
                    <button type="submit" id="loginBtn" class="w-full bg-homize-blue hover:bg-[#0EA5E9] text-white py-3 md:py-4 rounded-md font-medium shadow-sm transition-colors duration-200 mt-4">
                        MASUK
                    </button>
