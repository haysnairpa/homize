...
<head>
    ...
    <title>Pembayaran QRIS - Homize</title>
...
<body>
    <nav class="navbar">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <h1 class="text-lg font-semibold text-gray-800 hidden md:block">Pembayaran QRIS</h1>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div class="space-y-6">
                            <div class="bg-gray-50 p-6 rounded-xl border border-gray-100">
                                <h3 class="text-lg font-semibold text-gray-800 mb-4">Scan QRIS Code</h3>
                                
                                <div class="flex flex-col items-center justify-center">
                                    <img src="{{ asset('images/qris_code.svg') }}" alt="QRIS Code" class="w-64 h-64 mb-4">
                                    <button onclick="downloadQRIS()" class="text-homize-blue hover:text-homize-blue-second font-medium flex items-center gap-1">
                            ...
                            <div class="bg-yellow-50 p-6 rounded-xl border border-yellow-100">
                                ...
                                <ul class="list-disc pl-5 text-yellow-700 space-y-2">
                                    ...
                                    <li>Setelah melakukan pembayaran, silakan kirim bukti pembayaran melalui WhatsApp.</li>
                                </ul>
                            </div>
                        </div>
    ...
    <script>
        // Function to download QRIS image
        function downloadQRIS() {
            const link = document.createElement('a');
            link.href = "{{ asset('images/qris_code.svg') }}";
            link.download = 'qris_homize.svg';
