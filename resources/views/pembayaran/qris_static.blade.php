                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div class="space-y-6">
                            <div class="bg-gray-50 p-6 rounded-xl border border-gray-100">
                                ...
                                <div class="space-y-4">
                                    {{-- PAYMENT QRIS --}}
                                    <div class="space-x-4">
                                        <img src="{{ asset('images/qris_code.jpg') }}" alt="">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="bg-yellow-50 p-6 rounded-xl border border-yellow-100">
                                ...
                                <ul class="list-disc pl-5 text-yellow-700 space-y-2">
                                    <li>Pastikan Anda membayar dengan nominal yang <strong>TEPAT</strong> sesuai dengan
                                        total yang ditampilkan (termasuk kode unik).</li>
                                    <li>Pembayaran dengan nominal yang tidak sesuai akan menyulitkan proses verifikasi.
                                    </li>
                                    <li>Mohon cantumkan kode unik pada berita transfer untuk memudahkan verifikasi.</li>
                                    <li>Setelah melakukan pembayaran, silakan kirim bukti transfer melalui WhatsApp.
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="space-y-6">
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-700">Rp
                                            {{ number_format($booking->pembayaran->unique_code, 0, ',', '.') }}</p>
                                    </div>

                                    <div class="pt-2 border-t border-gray-200">
                                        <p class="text-sm font-medium text-gray-800">Total Pembayaran</p>
                                        <p class="text-xl font-bold text-homize-blue">
                                            {{ $booking->pembayaran->formatted_total_amount }}</p>
                            ...
                            <div class="bg-white p-6 rounded-xl border border-gray-200">
                                ...
                                <p class="text-gray-700 mb-4">Setelah melakukan pembayaran, silakan kirim bukti
                                    pembayaran melalui WhatsApp untuk diverifikasi oleh admin.</p>

                                <a href="{{ $whatsappUrl }}" target="_blank" id="whatsappButton"
                                    class="w-full bg-green-600 hover:bg-green-700 text-white font-medium py-4 px-6 rounded-xl transition duration-300 flex items-center justify-center gap-2 shadow-lg hover:shadow-xl">
