...
<body class="font-sans antialiased bg-homize-gray overflow-x-hidden relative min-h-screen min-w-screen">
        ...
        <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                ...
                <div class="md:w-1/2 p-8">
                    ...
                    <div class="mt-4 flex items-center">
                        <div class="flex items-center">
                            <span class="text-3xl font-bold text-gray-900">{{ number_format($layanan->rating_avg, 1) }}</span>
                            <div class="ml-2">
                                <div class="flex items-center">
                                    @for ($i = 1; $i <= 5; $i++)
            ...
            <div class="border-t border-gray-200 px-8 py-12">
                <div class="flex items-start gap-8 mb-12">
                    ...
                    <div class="flex-1">
                        ...
                        <div class="flex items-center gap-4 mt-4">
                            <button id="followBtn" 
                                    class="px-6 py-2 border-2 border-homize-blue text-homize-blue hover:bg-homize-blue hover:text-white rounded-full transition duration-300 flex items-center gap-2">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <button class="w-full bg-homize-blue hover:bg-homize-blue-second text-white font-medium py-4 px-6 rounded-xl transition duration-300 flex items-center justify-center gap-2 shadow-lg hover:shadow-xl">
                    ...
                    <button id="wishlistBtn" 
                            class="w-full border-2 border-gray-200 hover:border-homize-orange hover:bg-homize-orange/5 text-gray-700 hover:text-homize-orange font-medium py-4 px-6 rounded-xl transition duration-300 flex items-center justify-center gap-2">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="flex items-center gap-4 mb-6">
                        ...
                        <div class="flex-1">
                            <p class="text-lg mb-1">
                                @if($layanan->rating_count > 0)
                                    {{ round(($ratingStats[5] / $layanan->rating_count) * 100) }}% pembeli merasa puas
                                @else
                                    Belum ada ulasan
                                @endif
                            </p>
                                ...
                                @foreach(range(5, 1) as $star)
                                    <div class="flex items-center">
                                        ...
                                        <div class="flex-1 h-2 mx-2 bg-gray-200 rounded">
                                            @php
                                                $percentage = $layanan->rating_count > 0 
    ...
    <script>
        ...
        followBtn.addEventListener('click', function() {
            this.classList.toggle('bg-homize-blue');
            this.classList.toggle('text-white');
            this.innerHTML = this.classList.contains('bg-homize-blue') ? 
        ...
        wishlistBtn.addEventListener('click', function() {
            this.classList.toggle('text-homize-orange');
            this.classList.toggle('border-homize-orange');
