...
class DashboardController extends Controller
{
    public function dashboard()
    {
        ...
        $pendapatan = DB::select("SELECT SUM(p.amount) as total FROM booking b JOIN pembayaran p ON p.id_booking = b.id WHERE b.id_merchant = ? AND p.status_pembayaran = 'Selesai' AND b.customer_approval_date IS NOT NULL AND MONTH(b.customer_approval_date) = MONTH(CURRENT_DATE()) AND YEAR(b.customer_approval_date) = YEAR(CURRENT_DATE())", [$merchant->id]);
